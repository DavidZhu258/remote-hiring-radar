...
- 2026-06-02: Pushed commit `9529466` (`Expand remote hiring dashboard data view`) after using `GITHUB_CLASSIC_TOKEN` from the `signalfeed-infra` skill as a temporary git HTTP auth header. GitHub Actions completed successfully: Pages run `26801209559`, CI runs `26801210834` and `26801209606`. `gh-pages` updated to `6bba4f7`; the live Pages bundle `page-329967750caa2881.js` contains the new `limit:500` default.
